...
⚠️ **El tamaño de las fichas deslizables de móvil está elegido para que se vea que hay más.** Instructores a `62vw` (entra uno y medio) y reels a `52vw` (entran casi dos, y son 9:16, así que a más ancho un solo vídeo medía más que la pantalla de alto). A ficha casi de pantalla completa cada una parecía una página aparte y nadie descubría que se deslizan.
