...
| Portada de móvil | vídeo `videos/Itaca_Hero_Mobile.mp4`, con `poster="images/Itaca/Portada-movil.jpg"` | Grabado en vertical (9:16). Lo crea el JS de la portada de `index.html` solo por debajo de 760px; por encima usa el horizontal. Vídeo nuevo (6 de septiembre de 2026, distinto del de escritorio): el anterior no tenía pista de audio, así que no tenía sentido ponerle botón de sonido; este sí lleva audio real, con el mismo botón de sonido (`.video-control`) que la portada de escritorio. Se le recortaron los 0,4 s de negro del principio y del final: si no, parpadeaba en negro en cada vuelta del bucle. |
