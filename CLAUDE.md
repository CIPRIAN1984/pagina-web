...
| Fotos del gimnasio | `images/Itaca/Gym1.webp` … `Gym8.webp` (8, no 10) | Las lee el array `photos` del JS de `index.html` y el array `FOTOS` de `movil.html`. Si añades una foto, hay que añadirla en los dos sitios. `Gym8.webp` es nueva (6 de septiembre de 2026, foto de Drive recortada a 1200×800 desde un 1600×1066 original). |
