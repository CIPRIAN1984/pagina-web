...
⚠️ **Instructores en `#instructors` va en rejilla de 2 columnas en móvil, con la ficha que sobra ocupando la fila entera.** Cipri pidió (13 de septiembre de 2026) mejorar cómo se veían mientras solo hay 3 profesores: la fila deslizable solo enseñaba "una y media" y nadie entendía que había que arrastrar; una rejilla 2×2 a secas dejaba un hueco vacío en la cuarta celda.

Solución: `.instructors-grid .instructor-card:last-child:nth-child(odd) { grid-column: 1 / -1; }`. Cuando sobra una ficha suelta (posición impar y además la última), ocupa la fila entera en vez de dejar hueco. **Esto es automático y no hay que tocarlo al añadir o quitar profesores**: con 3 sale 2+1 ancho, con 4 sale 2×2 perfecto, con 5 vuelve a sobrar una y se ensancha, y así siempre. Ya no hace falta el disparador manual "cuando lleguen a 4" que decía una versión anterior de esta nota.
