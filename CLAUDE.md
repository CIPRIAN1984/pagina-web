...
⚠️ **Instructores en `#instructors` sigue como fila deslizable a propósito, no como rejilla 2×2.** Se probó la rejilla (12 de septiembre de 2026): con 3 fichas queda un hueco vacío en la cuarta celda y las fichas se acortan tanto que desaparece la biografía. Cipri confirmó el 13 de septiembre que **van a añadir más profesores**, así que la rejilla 2×2 es la solución correcta — pero solo cuando haya 4 (o un múltiplo de 2). **En cuanto se suba una cuarta foto de instructor, aplica a `#instructors` el mismo patrón de rejilla 2×2 que ya usa `.reels-grid`** (ver el bloque «Móvil con carácter editorial» al final del `<style>`); hasta entonces, no lo cambies aunque parezca inconsistente con los vídeos.
